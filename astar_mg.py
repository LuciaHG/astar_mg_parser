#!/usr/bin/env python2
# -*- coding: utf-8 -*-
"""The is the code for the A* MG parser from the paper "Wide-Coverage Neural A* Parsing for Minimalist Grammars"
by John Torr, Milos Stanojevic, Mark Steedman and Shay Cohen presented at ACL 2019.  Questions about the code should
be directed to John Torr (john.torr@cantab.net)"""
